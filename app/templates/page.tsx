...
import { getTemplatePackages } from "@/lib/supabase/actions";
import { FilePlus2, Printer, FileEdit, FolderOpen, AlertCircle } from "lucide-react";

export default async function TemplatesListPage() {
  const templatePackages = await getTemplatePackages().catch(() => []);
        ...
        {templatePackages.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1 max-w-sm">
              Create a new customer template package in the Setup Studio to get started.
            </p>
